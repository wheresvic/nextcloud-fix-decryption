...
return [
    ...
    "instance_id" => "ocwxw0qp9iav", // instance_id from your config file
    "instance_secret" => "IEBppf9SjnNEDZxmnAFXeI6RoZVElBTklB4WQbk+0+0aC8Dc", // instance_secret from your config file
    "current_db" => [
